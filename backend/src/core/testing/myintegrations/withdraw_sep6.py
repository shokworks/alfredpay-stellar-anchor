...
def sep6_withdraw(asset_code, amount):
    ...
    transaction1 = (
        ...
        .append_change_trust_op(asset=Asset(asset_code, cliente_public))
        .set_timeout(30)
        .build()
    )
    transaction1.sign(servidor_secret_key)
    ...
    transaction2 = (
        ...
        .append_payment_op(servidor_public, Asset(asset_code, cliente_public), amount)
        .set_timeout(30)
        .build()
    )
    transaction2.sign(cliente_secret_key)
